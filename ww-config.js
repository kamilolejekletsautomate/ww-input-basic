export default {
    ...
    triggerEvents: [
        ...
        { name: 'databaseValidation', label: { en: 'On database validation' }, event: { value: '', isValid: true, error: '' } },
    ],
    properties: {
        placeholderColor: {
            label: {
        ...
        type: {
            ...
            options: {
                options: [
                    ...
                    { value: 'database-text', label: { en: 'Database Text', fr: 'Texte Base de données' } },
                ],
            },
            defaultValue: 'text',
        },
        ...
        // Database validation type
        dbValidationFunction: {
            label: {
                en: 'Database function name',
            },
            type: 'Text',
            bindable: true,
            defaultValue: 'check_value_exists',
            /* wwEditor:start */
            bindingValidation: {
                type: 'string',
                tooltip: 'Name of the PostgreSQL function to validate values',
            },
            /* wwEditor:end */
        ...
        dbValidationTable: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'Name of the database table to validate against',
            },
            /* wwEditor:end */
            hidden: content => content.type !== 'database-text',
        },
        dbValidationColumn: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'Name of the column to validate against',
            },
            /* wwEditor:end */
            hidden: content => content.type !== 'database-text',
        },
        dbValidationDelay: {
            ...
            bindingValidation: {
                type: 'number',
                tooltip: 'Delay before validation in milliseconds',
            },
            /* wwEditor:end */
            hidden: content => content.type !== 'database-text',
        },
        ...
        dbValidationShowLoader: {
            ...
            bindingValidation: {
                type: 'boolean',
                tooltip: 'Show loading indicator during validation',
            },
            /* wwEditor:end */
            hidden: content => content.type !== 'database-text',
        },
